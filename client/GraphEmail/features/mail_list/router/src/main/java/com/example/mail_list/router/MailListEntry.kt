...
abstract class MailListEntry : ComposableFeatureEntry {
    ...
    final override val featureRoute =
        "mailListScreen?$START_DATE={$START_DATE}&$END_DATE={$END_DATE}&$SENDER={$SENDER}&$RECEIVER={$RECEIVER}&$SUBJECT={$SUBJECT}"
    ...
    fun destination(
        ...
        receiver: String?,
        subject: String?
    ): String = "mailListScreen?$START_DATE=$startDate&$END_DATE=$endDate&$SENDER=$sender&$RECEIVER=$receiver&$SUBJECT=$subject"
